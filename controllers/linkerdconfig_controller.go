...
// +kubebuilder:rbac:groups=config.linkerd.io,resources=linkerdconfigs,verbs=get;list;watch;create;update;patch;delete
...
func (r *LinkerdConfigReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	_ = r.Log.WithValues("linkerdconfig", req.NamespacedName)
